...
# installed.
TCL_PREFIX='/export/scratch2/as/somatic-mutation-caller/workflow/env/platypus'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/export/scratch2/as/somatic-mutation-caller/workflow/env/platypus'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/export/scratch2/as/somatic-mutation-caller/workflow/env/platypus/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/export/scratch2/as/somatic-mutation-caller/workflow/env/platypus/include'
...
TCL_PACKAGE_PATH='/export/scratch2/as/somatic-mutation-caller/workflow/env/platypus/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/export/scratch2/as/somatic-mutation-caller/workflow/env/platypus/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='-------src-dir-------/tcl8.5.18/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/export/scratch2/as/somatic-mutation-caller/workflow/env/platypus/lib/libtclstub8.5.a'
