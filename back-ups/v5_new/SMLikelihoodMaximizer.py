...
class SMLikelihoodMaximizer: 
	...
	def determinePosteriorProbabilitiesHypotheses(self, prior = [1/float(3.0), 1/float(3.0), 1/float(3.0)]):
		...
		"""
		likelihood_somatic_mutation, err = quad(self.help_likelihood0, 0.0, 1.0)
		int1, err = quad(self.help_likelihood1, 0.0, 1.0) 
		int2, err = quad(self.help_likelihood2, 0.0, 1.0) 
		likelihood_germline = int1 + int2
		likelihood_not_present 		= self.likelihood(0.0,0.0) 
