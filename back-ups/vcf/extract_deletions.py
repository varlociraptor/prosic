...
Extracts all deletions of a minimum length and with just one alternative from the 
VCF file <vcf-file> and stores them into a new VCF file <output-vcf-file>. 
Deletions on the sex chromosomes are neglected. 
