...
def main():
	...
	parser.add_option("-t", action="store", dest="truth_summary_file", default="data/truth.summary", 
				  		help="The location of file that contains the ground truth. (Default = data/truth.summary")
